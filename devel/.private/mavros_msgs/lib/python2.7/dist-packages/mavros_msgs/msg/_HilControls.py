...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_8f2B.pack(_x.roll_ailerons, _x.pitch_elevator, _x.yaw_rudder, _x.throttle, _x.aux1, _x.aux2, _x.aux3, _x.aux4, _x.mode, _x.nav_mode))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.roll_ailerons, _x.pitch_elevator, _x.yaw_rudder, _x.throttle, _x.aux1, _x.aux2, _x.aux3, _x.aux4, _x.mode, _x.nav_mode,) = _struct_8f2B.unpack(str[start:end])
      return self
